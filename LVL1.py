...
def draw_lvl1(button_main_manu, button_setting, money_picture, highlight_tile_images, is_used_additional_parameters, always_use, information_table, context):
        context.get_config_map().get_map_array()[0].draw(context)
        DefinitionCurrentTile.draw_highlighting(highlight_tile_images, context.get_config_map().get_map_array()[0].build_array, context)
        ...
        context.get_config_parameter_scene().get_screen().blit(money_picture, (420, 20))
        ...
        information_table.draw(context.get_config_parameter_scene().get_height(), context.get_config_parameter_scene().get_width(), context)
