...
class SettingsObjects:
    ...
    def draw_buttons(self, context):
        self.__button_additional_parameter.draw_button_with_text('Additional parameter:' + str(context.config_gameplay. get_always_use_additional_parameters()), context)
        self.__button_sound_setting.draw_button_with_text('Play sound:' + str(context.sound_controller.get_play_sound()), context)
        self.__button_music_setting.draw_button_with_text('Play music:' + str(context.sound_controller.get_play_music()), context)
