...
class Information:
    def __init__(self, height, width):
        ...
        self.__image = pygame.transform.scale(pygame.image.load(resource_path('images/UI/shop_background.png')), (height * 0.4, height))
        self.__modifier_array = ('free purchase', 'price up', 'health', 'money', 'damage')
        self.__image_characteristic_dict = {'health': pygame.image.load(resource_path('images/UI/enemy_characteristic/health.png')),
                                           'price': pygame.image.load(resource_path('images/UI/money.png')),
                                           'healing': pygame.image.load(resource_path('images/UI/enemy_characteristic/healing.png')),
                                           'armor': pygame.image.load(resource_path('images/UI/enemy_characteristic/shield.png')),
                                           'poison': pygame.image.load(resource_path('images/UI/enemy_characteristic/poison.png'))}
