...
class Highlighting:
    def __init__(self, context):
        self.__highlight_tile_image = pygame.transform.scale(pygame.image.load("images/UI/highlighting/highlighting_tower.png"), (context.maps_controller.get_tile_scale(), context.maps_controller.get_tile_scale()))  # картинка выделения
