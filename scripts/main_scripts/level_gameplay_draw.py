...
def draw_lvl(context, highlighting):
        context.maps_array_controller.draw_map(context)
        highlighting.draw_highlighting(context)
        context.towers_array_controller.draw_towers(context)
        context.enemies_array_controller.draw_enemies(context)
        ...
        context.towers_array_controller.draw_animation_upgrade(context)
        context.config_constant_object.shop.draw(context.towers_array_controller, context)  # рисует магазин
