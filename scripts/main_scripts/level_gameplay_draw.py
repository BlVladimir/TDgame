...
def draw_lvl(context, shop, highlighting):
        ...
        shop.draw(context.towers_controller, context)  # рисует магазин
        ...
        context.config_parameter_scene.get_screen().blit(shop.get_money_picture(), (context.config_parameter_scene.get_height() * 0.4, context.config_parameter_scene.get_height() * 0.05))
