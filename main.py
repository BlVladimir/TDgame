...
from scripts.array_controller import enemies_array_controller, maps_array_controller, towers_array_controller
...
maps_array_controller = maps_array_controller.MapsArrayController(config_parameter_screen.get_width(), config_parameter_screen.get_height())
highlighting = definition_current_tile.Highlighting(maps_array_controller)
...
towers_array_controller = towers_array_controller.TowerArrayController(maps_array_controller.get_tile_scale())
enemies_array_controller = enemies_array_controller.EnemiesArrayController()
...
context = context_class.Context(config_constant_object, config_gameplay, config_modifier, config_parameter_screen, animation_controller, enemies_array_controller, towers_array_controller, maps_array_controller, file_save_controller, sound_controller, event_controller, buttons_groups_controller)
...
while True:  # основной цикл
    for event in pygame.event.get():  # цикл получает значение event, и в зависимости от его типа делает определенное действие
        ...
        context.maps_array_controller.definition_current_tile(event, context)
