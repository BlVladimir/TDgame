...
class SettingsObjects:
    def __init__(self, width, height, change_using_additional_parameter, sound_controller):
        self.__button_additional_parameter = Button(width // 2 - height // 10, height // 2 - height//10, 'images/UI/satingButton.png', height//5, height//5, change_using_additional_parameter)
        self.__button_sound_setting = Button(width // 2 - 1.5 * height // 5 - height // 7, height // 2 - height//10, 'images/UI/satingButton.png', height//5, height//5, sound_controller.sound_setting)
        self.__button_music_setting = Button(width // 2 + height // 10 + height // 7, height // 2 - height//10,'images/UI/satingButton.png', height//5, height//5, sound_controller.music_setting)
