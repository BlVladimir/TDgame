...
def draw_lvl(context, shop, highlighting):
        ...
        context.get_config_parameter_scene().get_screen().blit(shop.money_picture, (context.get_config_parameter_scene().get_height() * 0.4, context.get_config_parameter_scene().get_height() * 0.05))
